class ShippingAddressesController < ApplicationController
  ...
  def new
    @billing_address = BillingAddress.find(@cart.billing_address.id)
  ...
  private
    ...
    def shipping_address_params
      params.require(:shipping_address).permit(:firstname, :lastname, :company, :address, :zip, :city, :province, :state, :telephone, :email, :order_id, :cart_id)
    end
end
